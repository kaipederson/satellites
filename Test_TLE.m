...
for hr = 0:23
    for min = 0:59 
        for sec = 0:10:59
            ...
            tim = satcom.internal.linkbudgetApp.computeElevation(43.81810593877638, -91.21248032918966, 0, pos_AO_73(1), pos_AO_73(2), pos_AO_73(3));
            if tim > 25
                tiny_tim = [tiny_tim, tim, string(time)];
            end
        end
    end
end
