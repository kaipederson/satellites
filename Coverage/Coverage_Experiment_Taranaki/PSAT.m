...
sat = satellite(sc, "PSAT(40054)_TLE")
...
tx_opps = [];
prev_angle = 0;
-39.2956059887398, 174.06322750403598, 0
for hr = 0:23
    for min = 0:59 
        for sec = 0:5:59
            ...
            angle = satcom.internal.linkbudgetApp.computeElevation(-39.2956059887398, 174.06322750403598, 0, pos(1), pos(2), pos(3));
            if angle >= 25
...
xlswrite('Coverage_Output_Taranaki/PSAT.xlsx',tx_opps)
